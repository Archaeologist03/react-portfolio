    ...
    <div className="about-myself-container">
      <h4 className="about-myself-container__text">
        ...
        <span className="voice-text voice-text--1">
          so ashamed of poor intro he gonna switch to third person{" "}
        </span>
        <br />
        ...
        <span className="about-myself-container__text--bolded">Python</span> and
        back-end, which he often says that it is his "somewhat long-term" tech
        to get into. But always with JS in heart pocket.
        <br />
      </h4>
    </div>
  );
